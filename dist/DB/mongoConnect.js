...
var listDatabases = function () { return __awaiter(void 0, void 0, void 0, function () {
    var databasesList;
...
var listCollections = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.db(process.env.DB_NAME).listCollections().toArray()];
            case 1:
                collections = _a.sent();
...
var getUserId = function (login, pass) { return __awaiter(void 0, void 0, void 0, function () {
    var result, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.db("medeordb").collection("autData")
                    .findOne()];
            case 1:
                result = (_a.sent()).data;
                user = result.find(function (user) { return user.login === login && user.pass === pass; });
                return [2 /*return*/, user === null || user === void 0 ? void 0 : user.id];
        }
    });
}); };
